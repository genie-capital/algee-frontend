        ...
        <div className="px-6 py-5 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="mt-3 sm:mt-0 flex flex-col sm:flex-row sm:space-x-3 space-y-2 sm:space-y-0">
              ...
              <select className="block w-full sm:w-auto pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#008401] focus:border-[#008401] sm:text-sm rounded-md" value={dateFilter} onChange={e => setDateFilter(e.target.value)}>
              ...
              <select className="block w-full sm:w-auto pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-[#008401] focus:border-[#008401] sm:text-sm rounded-md" value={actionFilter} onChange={e => setActionFilter(e.target.value)}>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredLogs.map(log => <tr key={log.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${log.action === 'login' ? 'bg-blue-100 text-blue-800' : log.action === 'logout' ? 'bg-purple-100 text-purple-800' : log.action === 'update' ? 'bg-yellow-100 text-yellow-800' : log.action === 'calculate' ? 'bg-green-100 text-green-800' : log.action === 'batch' ? 'bg-indigo-100 text-indigo-800' : log.action === 'export' ? 'bg-pink-100 text-pink-800' : log.action === 'system' ? 'bg-gray-100 text-gray-800' : 'bg-blue-100 text-blue-800'}`}>
